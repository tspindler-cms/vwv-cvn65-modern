...
--	VppStartPoint; 		   azimuth (degree} 	  Length_Vpp; 	   Width_Vpp;
	{{-59.659, 19.55, -9.9}, 348.5,		   97.0, 			   20.0,  --somewhere between last wire and model center / just past last wire 72 TO 52
...
-- 72.5735 and 62.5735 are short, are working runway lengths
	{{65.721, 19.55,     13.418 }, 	     	356.00, 		      90.9403, 		    20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 1 location
	{{65.932, 19.55,   -9.3259 }, 		    002.00, 		      90.8136, 	        20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 2 location
	{{-41.213, 19.55,  -20.003 }, 		    353.00, 	    	  91.1863, 	        20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 3 location
	{{-52.678,  19.55,  -33.233 }, 		    000.0, 		    	  66.2523, 	        20.0, 		0, 2.5, 2.8, 3.0, 3.0, 3.2, 3.5},  --  Cat 4 location
};
