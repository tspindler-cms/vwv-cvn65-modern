...
-- CVN-65 Enterprise by TeTeT

GT = {};
-- TODO
dofile(current_mod_path..'/Database/EnterpriseRunwaysAndRoutes.lua') -- the runways and taxiway lua file
GT_t.ws = 0;

set_recursive_metatable(GT, GT_t.generic_ship) -- all ships have this

GT.visual = {}
GT.visual.shape = "cvn65_dcs"  -- name of LODs lua
...
GT.radar1_period = 8; --speed
GT.radar2_period = 2.7; --speed
...
GT.Name = "cvn-65" -- folder name for Liveries
GT.DisplayName = _("CVN-65 Enterprise") -- name in game in ME and on the tape at the bottom
GT.DisplayNameShort = _("CVN-65") -- Label name
GT.Rate = 5500.000000
